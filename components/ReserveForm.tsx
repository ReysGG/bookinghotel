    ...
    return (
        <div>
            <form action={formAction}>
                ...
                <button className='px-10 py-3 text-center font-semibold text-white w-full bg-blue-600 rounded-sm cursor-pointer hover:bg-blue-500' type='submit' disabled={pending}>{pending ? "Loading..." : "Reserve"}</button>
            </form>
        </div>
    );
};
