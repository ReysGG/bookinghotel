...
import { Amenities, Room } from "@/lib/generated/prisma";
...
const EditForm = ({ amenities, room }: { amenities: Amenities[], room: RoomProps }) => {
    ...
    const [Output, FormAction, process] = useActionState(updateRoom.bind(null, image, room.id), null)
    const checkedAmenities = room.RoomAmenities.map((item : any) => item.amenitiesId)
