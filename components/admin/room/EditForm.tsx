        ...
        <div className="grid md:grid-cols-12 gap-5">
          ...
          <div className=" col-span-4 bg-white p-4">
              ...
              <div className="flex flex-col items-center justify-center text-gray-500 pt-5 pb-6 z-10">
                ...
                {image ? (
                  <button
                    ...
                    className="flex items-center justify-center bg-red-400 size-6 rounded-sm absolute right-1 top-1 text-white hover:bg-red-200"
                  >
            ...
            <button
              type="submit"
              className={clsx(
                "bg-blue-600 text-white w-full hover:bg-blue-700 py-2.5 px-6 md:px-10 text-lg font-semibold cursor-pointer",
                {
