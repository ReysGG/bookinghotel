...
const CheckoutDetail = async ({ reservationId }: { reservationId: string }) => {
    ...
    if (!reservation || !reservation.Payment) return notFound()
            ...
            <div className="order-2">
                <div className="flex flex-col mb-3 items-start bg-white border border-gray-200 rounded-sm md:flex-row md:w-full">
                    <div className="aspect-video relative">
                        <Image src={reservation.Room.image} alt={reservation.Room.name} width={500} height={300}
                            className="object-cover w-full rounded-t-sm aspect-video md:rounded-s-sm"></Image>
                    </div>
                ...
                <table className="w-full">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="py-2 text-right truncate">{duration} {duration <= 1 ? "Night" : "Nights"}</td>
                        </tr>
                        <tr>
