  ...
  return (
    <>
      <div className="">
        <HeaderSection
          title="Contact Us"
          description="Nibbers Nibbers Nibbers Nibbers"
        ></HeaderSection>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-700 py-5">
                ...
                out to us. Our team is here to help you with anything you need.
              </p>
              <ul className="list-item space-y-6 pt-8">
                ...
                <li className="flex gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <p>
                      Jl. Raya Canggu No.88, Kec. Kuta Utara, Kabupaten Badung,
                      Bali 80361
                    </p>
                  </div>
                </li>
